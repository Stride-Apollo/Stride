...
public:
	...
	Traveller(const PersonType& home_person, PersonType* new_person, const string& home_sim_id,
			  const string& destination_sim_id, uint home_simulator_index)
	...
	Traveller(const Traveller& other_traveller)
			: m_home_simulator_id(other_traveller.m_home_simulator_id),
			  m_destination_simulator_id(other_traveller.m_destination_simulator_id),
			  m_home_simulator_index(other_traveller.m_home_simulator_index),
